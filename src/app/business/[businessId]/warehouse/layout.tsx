// /business/[businessId]/warehouse/layout.tsx
'use client';
...
export default function WarehouseLayout({
    ...
    const isActive = (href: string) => {
        if (href === `/business/${businessId}/warehouse`) {
            ...
            <aside className="hidden lg:flex flex-col w-[280px] border-r bg-gradient-to-b from-background via-background to-muted/20">
                ...
                <div className="p-6 border-b">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="font-semibold text-lg tracking-tight">Warehouse</h2>
                            <p className="text-xs text-muted-foreground">Manage storage locations</p>
                        </div>
                    </div>
                </div>
