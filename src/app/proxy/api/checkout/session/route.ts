...
const APP_ORIGIN  = (process.env.APP_ORIGIN || "https://majime.in").replace(/\/+$/,"");
const SOURCE_PATH = "/checkout";  // Your actual checkout page path
const PROXY_PREFIX = "/apps/majime/api/checkout";  // Match your App Proxy config
