  ...
  return (
    <div className="flex justify-center items-start h-full p-4 md:p-6">
      <Card className="w-full max-w-4xl">
         <CardHeader>
            <CardTitle className="text-2xl font-headline">General Settings</CardTitle>
            <CardDescription>Manage your general account and application settings.</CardDescription>
         </CardHeader>
         <CardContent>
