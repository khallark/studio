                ...
                <div className="border-b border-gray-200 shrink-0 bg-white shadow-sm">
                  <div className="overflow-x-auto px-2 sm:px-4 scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">
                      <TabsList className="inline-flex h-auto rounded-none bg-transparent p-0 gap-0 min-w-max">
                          <TabsTrigger value="All Orders" className="flex-shrink-0 whitespace-nowrap rounded-none border-b-2 border-transparent bg-transparent px-3 sm:px-4 py-3 text-sm font-semibold text-gray-500 shadow-none transition-all duration-200 ease-in-out hover:text-gray-700 hover:bg-gray-50 data-[state=active]:border-blue-500 data-[state=active]:text-blue-600 data-[state=active]:bg-blue-50 data-[state=active]:shadow-none">
                              All ({statusCounts['All Orders'] || 0})
                          </TabsTrigger>
                          <TabsTrigger value="New" className="flex-shrink-0 whitespace-nowrap rounded-none border-b-2 border-transparent bg-transparent px-3 sm:px-4 py-3 text-sm font-semibold text-gray-500 shadow-none transition-all duration-200 ease-in-out hover:text-gray-700 hover:bg-gray-50 data-[state=active]:border-blue-500 data-[state=active]:text-blue-600 data-[state=active]:bg-blue-50 data-[state=active]:shadow-none">
                              New ({statusCounts['New'] || 0})
                          </TabsTrigger>
                          <TabsTrigger value="Confirmed" className="flex-shrink-0 whitespace-nowrap rounded-none border-b-2 border-transparent bg-transparent px-3 sm:px-4 py-3 text-sm font-semibold text-gray-500 shadow-none transition-all duration-200 ease-in-out hover:text-gray-700 hover:bg-gray-50 data-[state=active]:border-blue-500 data-[state=active]:text-blue-600 data-[state=active]:bg-blue-50 data-[state=active]:shadow-none">
                              Confirmed ({statusCounts['Confirmed'] || 0})
                          </TabsTrigger>
                          <TabsTrigger value="Ready To Dispatch" className="flex-shrink-0 whitespace-nowrap rounded-none border-b-2 border-transparent bg-transparent px-3 sm:px-4 py-3 text-sm font-semibold text-gray-500 shadow-none transition-all duration-200 ease-in-out hover:text-gray-700 hover:bg-gray-50 data-[state=active]:border-blue-500 data-[state=active]:text-blue-600 data-[state=active]:bg-blue-50 data-[state=active]:shadow-none">
                              Ready To Dispatch ({statusCounts['Ready To Dispatch'] || 0})
                          </TabsTrigger>
                          <TabsTrigger value="Dispatched" className="flex-shrink-0 whitespace-nowrap rounded-none border-b-2 border-transparent bg-transparent px-3 sm:px-4 py-3 text-sm font-semibold text-gray-500 shadow-none transition-all duration-200 ease-in-out hover:text-gray-700 hover:bg-gray-50 data-[state=active]:border-blue-500 data-[state=active]:text-blue-600 data-[state=active]:bg-blue-50 data-[state=active]:shadow-none">
                              Dispatched ({statusCounts['Dispatched'] || 0})
                          </TabsTrigger>
                          <TabsTrigger value="In Transit" className="flex-shrink-0 whitespace-nowrap rounded-none border-b-2 border-transparent bg-transparent px-3 sm:px-4 py-3 text-sm font-semibold text-gray-500 shadow-none transition-all duration-200 ease-in-out hover:text-gray-700 hover:bg-gray-50 data-[state=active]:border-blue-500 data-[state=active]:text-blue-600 data-[state=active]:bg-blue-50 data-[state=active]:shadow-none">
                              In Transit ({statusCounts['In Transit'] || 0})
                          </TabsTrigger>
                          <TabsTrigger value="Out For Delivery" className="flex-shrink-0 whitespace-nowrap rounded-none border-b-2 border-transparent bg-transparent px-3 sm:px-4 py-3 text-sm font-semibold text-gray-500 shadow-none transition-all duration-200 ease-in-out hover:text-gray-700 hover:bg-gray-50 data-[state=active]:border-blue-500 data-[state=active]:text-blue-600 data-[state=active]:bg-blue-50 data-[state=active]:shadow-none">
                              Out For Delivery ({statusCounts['Out For Delivery'] || 0})
                          </TabsTrigger>
                          <TabsTrigger value="Delivered" className="flex-shrink-0 whitespace-nowrap rounded-none border-b-2 border-transparent bg-transparent px-3 sm:px-4 py-3 text-sm font-semibold text-gray-500 shadow-none transition-all duration-200 ease-in-out hover:text-gray-700 hover:bg-gray-50 data-[state=active]:border-blue-500 data-[state=active]:text-blue-600 data-[state=active]:bg-blue-50 data-[state=active]:shadow-none">
                              Delivered ({statusCounts['Delivered'] || 0})
                          </TabsTrigger>
                          <TabsTrigger value="RTO In Transit" className="flex-shrink-0 whitespace-nowrap rounded-none border-b-2 border-transparent bg-transparent px-3 sm:px-4 py-3 text-sm font-semibold text-gray-500 shadow-none transition-all duration-200 ease-in-out hover:text-gray-700 hover:bg-gray-50 data-[state=active]:border-blue-500 data-[state=active]:text-blue-600 data-[state=active]:bg-blue-50 data-[state=active]:shadow-none">
                              RTO In Transit ({statusCounts['RTO In Transit'] || 0})
                          </TabsTrigger>
                          <TabsTrigger value="RTO Delivered" className="flex-shrink-0 whitespace-nowrap rounded-none border-b-2 border-transparent bg-transparent px-3 sm:px-4 py-3 text-sm font-semibold text-gray-500 shadow-none transition-all duration-200 ease-in-out hover:text-gray-700 hover:bg-gray-50 data-[state=active]:border-blue-500 data-[state=active]:text-blue-600 data-[state=active]:bg-blue-50 data-[state=active]:shadow-none">
                          ...
                          <TabsTrigger value="DTO Booked" className="flex-shrink-0 whitespace-nowrap rounded-none border-b-2 border-transparent bg-transparent px-3 sm:px-4 py-3 text-sm font-semibold text-gray-500 shadow-none transition-all duration-200 ease-in-out hover:text-gray-700 hover:bg-gray-50 data-[state=active]:border-blue-500 data-[state=active]:text-blue-600 data-[state=active]:bg-blue-50 data-[state=active]:shadow-none">
                              DTO Booked ({statusCounts['DTO Booked'] || 0})
                          </TabsTrigger>
                          <TabsTrigger value="DTO In Transit" className="flex-shrink-0 whitespace-nowrap rounded-none border-b-2 border-transparent bg-transparent px-3 sm:px-4 py-3 text-sm font-semibold text-gray-500 shadow-none transition-all duration-200 ease-in-out hover:text-gray-700 hover:bg-gray-50 data-[state=active]:border-blue-500 data-[state=active]:text-blue-600 data-[state=active]:bg-blue-50 data-[state=active]:shadow-none">
                              DTO In Transit ({statusCounts['DTO In Transit'] || 0})
                          </TabsTrigger>
                          <TabsTrigger value="DTO Delivered" className="flex-shrink-0 whitespace-nowrap rounded-none border-b-2 border-transparent bg-transparent px-3 sm:px-4 py-3 text-sm font-semibold text-gray-500 shadow-none transition-all duration-200 ease-in-out hover:text-gray-700 hover:bg-gray-50 data-[state=active]:border-blue-500 data-[state=active]:text-blue-600 data-[state=active]:bg-blue-50 data-[state=active]:shadow-none">
                              DTO Delivered ({statusCounts['DTO Delivered'] || 0})
                          </TabsTrigger>
                          <TabsTrigger value="Lost" className="flex-shrink-0 whitespace-nowrap rounded-none border-b-2 border-transparent bg-transparent px-3 sm:px-4 py-3 text-sm font-semibold text-gray-500 shadow-none transition-all duration-200 ease-in-out hover:text-gray-700 hover:bg-gray-50 data-[state=active]:border-blue-500 data-[state=active]:text-blue-600 data-[state=active]:bg-blue-50 data-[state=active]:shadow-none">
                              Lost ({statusCounts['Lost'] || 0})
                          </TabsTrigger>
                          <TabsTrigger value="Closed" className="flex-shrink-0 whitespace-nowrap rounded-none border-b-2 border-transparent bg-transparent px-3 sm:px-4 py-3 text-sm font-semibold text-gray-500 shadow-none transition-all duration-200 ease-in-out hover:text-gray-700 hover:bg-gray-50 data-[state=active]:border-blue-500 data-[state=active]:text-blue-600 data-[state=active]:bg-blue-50 data-[state=active]:shadow-none">
                              Closed ({statusCounts['Closed'] || 0})
                          </TabsTrigger>
                          <TabsTrigger value="RTO Closed" className="flex-shrink-0 whitespace-nowrap rounded-none border-b-2 border-transparent bg-transparent px-3 sm:px-4 py-3 text-sm font-semibold text-gray-500 shadow-none transition-all duration-200 ease-in-out hover:text-gray-700 hover:bg-gray-50 data-[state=active]:border-blue-500 data-[state=active]:text-blue-600 data-[state=active]:bg-blue-50 data-[state=active]:shadow-none">
                              RTO Closed ({statusCounts['RTO Closed'] || 0})
                          </TabsTrigger>
                          <TabsTrigger value="Cancelled" className="flex-shrink-0 whitespace-nowrap rounded-none border-b-2 border-transparent bg-transparent px-3 sm:px-4 py-3 text-sm font-semibold text-gray-500 shadow-none transition-all duration-200 ease-in-out hover:text-gray-700 hover:bg-gray-50 data-[state=active]:border-blue-500 data-[state=active]:text-blue-600 data-[state=active]:bg-blue-50 data-[state=active]:shadow-none">
